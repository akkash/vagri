...
export default () => {
  ...
  return (
    <div className="mh-full-screen d-flex align-items-center dark-overlay">
      <img
        src="content/img/photo/ipic3.jpg"
        alt="Coming Soon"
        className="bg-image"
      />
      <Container className="text-white text-center text-lg overlay-content py-6 py-lg-0">
        ...
        <h3 className="mb-5 text-shadow">
          Our Vagri Listings are coming to you soon.
        </h3>
        <p className="font-weight-light mb-4">
          <i className="fas fa-map-marker-alt mr-2" /> Vagri. | Made Out of LUV
          from Erode,Tamil Nadu, IN
        </p>
